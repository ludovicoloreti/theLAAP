...
- `misura_test.go` — parsing di `footprint`, `vm_stat`, `lms ps`, `ollama ps` su output
  registrati, inclusi output malformati e vuoti.
- `sicurezza_test.go` — le rotte mutanti rifiutano richieste senza `Origin` valido e senza
